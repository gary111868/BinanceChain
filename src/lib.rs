...
#[derive(Debug)]
pub struct BinanceChainProcessor {
    verbose: bool,
    processed_count: usize,
}

impl BinanceChainProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BinanceChain processing");
    
    let mut processor = BinanceChainProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BinanceChainProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BinanceChainProcessor::new(false);
